...
def write_json(i,article, abstract):
	...
	file = "/ssd3/xiaojingwu/Generating_Text_Summary_With_GPT2/CNN/gpt2_1024_data2/"+str(i)+".json"
	js_example = {}
	js_example['id'] = i
...
if __name__ == '__main__':
	...
	file_names = [file for file,size in file_sizes.items()] #only consider files with total no of tokens less than 1024
